...
export function exec(receiver: u64, c: u64, action: u64): void {
    var gol: HelloWorld = new HelloWorld(receiver, c);
    let x = 3
}
export function foo(receiver: u64, coder: u64, action: u64): void {
}
